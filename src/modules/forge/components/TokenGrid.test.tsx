...
function makeToken(symbol: string, isOwn = false): TokenInfo {
  return {
...
function resetStore() {
  // Use merge mode (false) to preserve action functions in the store
...
describe("TokenGrid", () => {
  ...
  it("filter checkbox shows only own tokens when checked", () => {
  ...
  it("own tokens appear before non-own tokens", () => {
