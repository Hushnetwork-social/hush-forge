...
describe("market-data-service", () => {
  ...
  it("lists only speculative pairs with successful curve reads and sorts newest first", async () => {
    ...
    expect(vi.mocked(getBondingCurveState)).toHaveBeenNthCalledWith(2, "0xrouter", "0xccc");
  });
